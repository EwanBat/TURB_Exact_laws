...
from .source_rvbetadu import SourceRvbetadu, calc_in_point_with_sympy, calc_in_point_with_sympy_traj, calc_with_fourier
...
class SourceRvbetadupol(SourceRvbetadu):
    ...
    def calc(self, vector: List[int], cube_size: List[int], rho, vx, vy, vz, pm, ppol, dxupol, dyupol, dzupol, traj=False, **kwarg) -> List[float]:
        if traj:
            return calc_source_with_numba_traj(calc_in_point_with_sympy_traj, *vector, *cube_size, rho, vx, vy, vz, pm, ppol, dxupol, dyupol, dzupol)
