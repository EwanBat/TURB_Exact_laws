...
class SourcePpolvdrdr(SourcePisovdrdr):
    ...
    def calc(
        self, vector: List[int], cube_size: List[int], rho, vx, vy, vz, ppol, dxrho, dyrho, dzrho, traj=False, **kwarg
    ) -> List[float]:
        if traj:
            return calc_source_with_numba_traj(calc_in_point_with_sympy_traj, *vector, *cube_size, rho, vx, vy, vz, ppol, dxrho, dyrho, dzrho)
        return calc_source_with_numba(calc_in_point_with_sympy, *vector, *cube_size, rho, vx, vy, vz, ppol, dxrho, dyrho, dzrho)

    def calc_fourier(self, rho, vx, vy, vz, ppol, dxrho, dyrho, dzrho, traj=False, **kwarg) -> List:
        return calc_with_fourier(rho, vx, vy, vz, ppol, dxrho, dyrho, dzrho, traj=traj)
