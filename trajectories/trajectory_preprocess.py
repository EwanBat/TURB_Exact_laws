...
def load_oca_data(input_folder: str, cycle: str, sim_type: str):
    """
...
def load_config_from_ini(config_file: str, input_folder: str = ""):
    """
...
def preprocess_trajectory_from_ini(ini_file: str,
    ...
    # Data structure is now uniform: {sat_name: {var_name: array(n_trajectories, n_points)}}
    
    # Get first satellite name
    first_sat = list(dic_datas.keys())[0] if dic_datas else 'sat_0'
    
    if 'ppar' in dic_datas.get(first_sat, {}):
        physical_param["meanppar"] = {
